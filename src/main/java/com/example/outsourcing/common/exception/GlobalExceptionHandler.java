...
import com.example.outsourcing.common.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    protected CommonResponse<Void> handleCustomException(CustomException e) {
    ...
    protected CommonResponse<Void> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        log.error("MethodArgumentNotValidException: {}", e.getMessage());
        List<ErrorResponse.FieldError> fieldErrors = processFieldErrors(e.getBindingResult());

        return CommonResponse.error(ErrorCode.INVALID_INPUT_VALUE,fieldErrors);
    ...
    protected CommonResponse<Void> handleEntityNotFoundException(EntityNotFoundException e) {
        log.error("EntityNotFoundException: {}", e.getMessage());

        return CommonResponse.error(ErrorCode.ENTITY_NOT_FOUND);
    }
    ...
    protected CommonResponse<Void> handleDataAccessException(DataAccessException e) {
    ...
    protected CommonResponse<Void> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
    ...
    protected CommonResponse<Void> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e) {
        log.error("MethodArgumentTypeMismatchException: {}", e.getMessage());

        return CommonResponse.error(ErrorCode.INVALID_TYPE_VALUE);
    }
    ...
    protected CommonResponse<Void> handleMissingServletRequestParameterException(MissingServletRequestParameterException e) {
    ...
    protected CommonResponse<Void> handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
